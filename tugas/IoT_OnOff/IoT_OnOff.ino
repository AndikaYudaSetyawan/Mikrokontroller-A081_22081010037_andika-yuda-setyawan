...
const char* ssid = "RS Wali Songo"; // Enter your WiFi name
...
//    if (client.connect("ESP32Client", mqttUser, mqttPassword )) {
    ...
    client.subscribe("heater1yuda");
    client.subscribe("heater2bayu");
  }
}
...
void loop() { 
  ...
  client.publish("Suhu1yuda",suhu1);
  ...
  client.publish("Suhu2bayu",suhu2);
